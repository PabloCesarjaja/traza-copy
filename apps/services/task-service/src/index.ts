// index.ts — Punto de entrada del servicio task-service.
...
aplicacion.get('/health', (_req: Request, res: Response) => {
    res.json({ estado: 'activo', servicio: 'task-service', entorno: ENTORNO });
});
...
aplicacion.listen(PUERTO, () => {
    console.log(`[task-service] Escuchando en puerto ${PUERTO} (${ENTORNO})`);
});
