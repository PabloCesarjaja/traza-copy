// index.ts — Punto de entrada del servicio audit-service.
...
aplicacion.get('/health', (_req: Request, res: Response) => {
    res.json({ estado: 'activo', servicio: 'audit-service', entorno: ENTORNO });
});
...
aplicacion.listen(PUERTO, () => {
    console.log(`[audit-service] Escuchando en puerto ${PUERTO} (${ENTORNO})`);
});
